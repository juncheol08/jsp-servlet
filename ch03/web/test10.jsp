...
<div class="container">
    ...
    <hr>
    <h2>EL Operation - Arithmetic(산술연산)</h2>
    ...
    <p>num3 > num4 = ${num4 gt num3 }</p>
    <p>num3 < num4 = ${num4 lt num3 }</p>
    <p>num3 >= num4 = ${num4 ge num3 }</p>
    <p>num3 >= num4 = ${num4 le num3 }</p>
    <p>num3 == num4 = ${num4 eq num3 }</p>
    <hr>
